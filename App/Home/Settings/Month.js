...
import {Header,Container, Left, Body, Right, Button, Title, Text,Content,Icon,ListItem,H3,H1,H2,Subtitle} from 'native-base';
...
class App extends Component < Props > {
    ...
    render() {
      ...
      <View style={{flex: 2, flexDirection: 'column',alignItems: 'center',justifyContent: 'center',backgroundColor : "#0000"}}>
         <Text style={{fontSize:20,fontFamily:'Montserrat-Thin',margin:3}}>{moment().format('MMMM')}</Text>
      </View>
